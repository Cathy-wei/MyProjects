...
<div class="head">
	  <h4><a href="index.jsp">大学生拼车系统</a></h4>
	     <div class="d0">
	     	<ul class="d01">
	    		<li><a href="searchCarpool_t.jsp">按时间查询</a>
...
<div class="col-md-12 mx-auto">
	...
	<form action="searchp.do" method="post"  name="form1"id="form1"  class="col-md-6 mx-auto">
	  		<div class="row tm-flex-lr" > 
			   从 <div class="col-sm-4">
			        <input placeholder="出发地点" name="departureplace" type="text" class="validate">
			    </div>
			  到  <div class="col-sm-4">
			        <input placeholder="到达地点" name="destination" type="text" class="validate">
			    </div>	
	...
	<div class="box">
	     <div class="table-responsive">
						<table class="table">
						  ...
						  <tbody class="scroll">
		<%
			List carpool = (List)session.getAttribute("carpool_p");
			if(carpool!=null){
...
function check(){
	if(form1.departureplace.value==""||form1.destination.value==""){
		alert("出发地点 或 到达地点不能为空！");
		return false;
	}
